...
// module
exports.push([module.i, ".ls-about-small {\n    display: block;\n    font-size: 80%;\n    line-height: 1.42857143;\n    color: #777;\n}\n\n.ls-about-dl {\n    margin-left: -90px;\n}\n\n.ls-nav-search-form {\n    margin-top: 0px;\n    margin-bottom: 2px;\n    border-top: hidden;\n    border-bottom: hidden;\n}\n\n.ls-hide-nav {\n    display: none!important;\n}\n\n.ls-nav-search-well {\n    margin: -5px 50px 0 50px;\n}\n\n", ""]);
...
var Lattespirit = function () {
    ...
    _createClass(Lattespirit, [{
        ...
        key: 'refreshArticles',
        value: function refreshArticles() {
            var articles = [];
        ...
        key: 'articlesExpired',
        value: function articlesExpired() {
            $.ajax({
                url: '/search.json',
                dataType: 'json'
            }).done(function (data) {
                var lastModified = data.lastModified;
                var cachedLastModified = localStorage.getItem('lastModified');
